  ...
  return (
    <div className="py-12 bg-transparent text-slate-850 min-h-[700px] flex items-center font-sans">
      <div className="mx-auto max-w-md w-full px-4 sm:px-6 space-y-8">
        ...
        {/* Samsung One UI Header: Giant text, soft and comfortable descriptions */}
        <div className="text-center space-y-3">
          <div className="mx-auto h-14 w-14 bg-blue-50 rounded-full flex items-center justify-center border border-blue-100">
            <LogIn className="h-6 w-6 text-blue-650" />
          </div>
        ...
        {/* Samsung Segmented Switcher Control */}
        ...
        {/* Auth Body Card — Samsung Device Care style rounded card */}
              ...
              {isAuthNotAllowed && (
                <div className="border border-slate-200 bg-slate-50 p-4 rounded-2xl space-y-3 text-slate-705 text-xs shadow-xs">
                  <div className="font-extrabold text-slate-800 flex items-center gap-1.5">
                    ...
                    <span>How to enable Email/Password Authentication:</span>
                  </div>
                  <ol className="list-decimal list-inside space-y-1 ml-1 leading-relaxed text-slate-600">
                    ...
                    <li>Click <strong>Add new provider</strong> (or edit <strong>Email/Password</strong>).</li>
