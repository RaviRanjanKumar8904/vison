          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
            <div className="space-y-2 text-center md:text-left">
              ...
              <h2 className="text-lg sm:text-xl font-display font-extrabold text-slate-900 flex flex-wrap items-center justify-center md:justify-start gap-2">
                ...
                <span className="text-slate-400 line-through font-mono font-normal">₹499/wk</span>
                <span className="text-emerald-700 font-mono">₹99 onwards!</span>
              </h2>
              <p className="text-xs text-slate-600 max-w-xl">
                Invigo academic boards have waived the structural cost of all 16 domains! Lock in your verified node seat instantly. Pay only for the cohort period you choose with our subsidized learning matrix:
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 w-full md:w-auto shrink-0 font-mono">
              <div className="p-4 rounded-2xl bg-white border border-slate-205 text-center space-y-1 min-w-32 shadow-xs">
                ...
                <span className="text-[9px] text-emerald-650 font-sans block font-bold">Save 80% off ₹499</span>
              </div>
              <div className="p-4 rounded-2xl bg-white border border-slate-205 text-center space-y-1 min-w-32 shadow-xs">
                ...
                <span className="text-[9px] text-emerald-650 font-sans block font-bold">Save 81% off ₹799</span>
              </div>
            </div>
          </div>
        </div>
